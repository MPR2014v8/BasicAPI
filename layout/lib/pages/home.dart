...
class _HomePageState extends State<HomePage> {
        ...
        body: Padding(
            ...
            child: FutureBuilder(
              builder: (context, AsyncSnapshot snapshot) {
                //  snapshot => List ของข้อมูลใน json แบบ [{},{},{},..,{}]
                //  data = [{คอมพิวเตอร์....},{},{}]
                //  ข้อมูลถูกดึงมาจาก future:
  ...
  Future getData() async {
    //  https://raw.githubusercontent.com/MPR2014v8/BasicAPI/main/data.json
    var url = Uri.https('raw.githubusercontent.com', '/MPR2014v8/BasicAPI/main/data.json');
